...
# After we have to implement firebase in our project

# import these files in firebase.js file that should be available in firebase project!!
...
# -------------------------------------------------------------------------------------
It is not necessay to sue async when we use redux
